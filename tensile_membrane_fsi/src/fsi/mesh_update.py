"""Update immersed-boundary mask and solid velocity from membrane state."""
...
from ..fluid.mesh import FluidGrid, membrane_cell_mask
from ..fluid.piso import FluidSolver
from ..membrane.geometry import MembraneMesh


def update_immersed_boundary(
    fluid: FluidSolver,
    grid: FluidGrid,
    mesh: MembraneMesh,
    nodes: np.ndarray,
    ...
    """Refresh fluid obstacle mask and solid velocity from membrane motion.

    Returns the boolean mask of blocked cells.
    """
    mask = membrane_cell_mask(grid, nodes, thickness_cells=thickness_cells)
